...
* **Is this plugin also a building system manager?** No, it is not. For convenience, we provide the option `Run Makefile`, which should cover most cases of use. But if your workflow relies heavily on building systems, please consider installing a building system manager neovim plugin.
