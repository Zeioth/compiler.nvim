...
For building systems not directly supported by Compiler.nvim: By creating a Makefie you can call cmake, clang or any other build system you want to use from there.
