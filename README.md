...
If you find any issue while using the compiler, please open an issue an I will look into it, just be aware until all languages are implemented and the unit tests have been finished, the compiler won't be considered a final product.
