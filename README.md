...
* Next iteration: By using ripgrep, it would be possible to discover what files are the entry point files without the need of using the conventional name → This is UNIX exclusive though.
