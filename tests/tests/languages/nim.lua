...
--- @usage :luafile ~/.local/share/nvim/lazy/compiler.nvim/tests/tests/languages/nim.lua

local ms = 1000 -- wait time
local language = require("compiler.languages.nim")
local example =
  require("compiler.utils").get_tests_dir("code samples/languages/nim/")
