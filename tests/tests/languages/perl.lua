...
--- @usage :luafile ~/.local/share/nvim/lazy/compiler.nvim/tests/tests/languages/perl.lua

local ms = 1000 -- wait time
local language = require("compiler.languages.perl")
local example = vim.fn.stdpath "data" .. "/lazy/compiler.nvim/tests/examples/languages/perl/"
