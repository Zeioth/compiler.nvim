...
--- @usage :luafile ~/.local/share/nvim/lazy/compiler.nvim/tests/tests/languages/cpp.lua

local ms = 1000 -- wait time
local language = require("compiler.languages.cpp")
local example = vim.fn.stdpath "data" .. "/lazy/compiler.nvim/tests/examples/languages/cpp/"
