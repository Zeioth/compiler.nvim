...
-- ============================= INTERPRETED ==================================
example = vim.fn.stdpath "data" .. "/lazy/compiler.nvim/tests/examples/dart/interpreted/"
...
-- ============================= MACHINE CODE =================================
example = vim.fn.stdpath "data" .. "/lazy/compiler.nvim/tests/examples/dart/machine-code/"
...
-- =============================== OTHER ===================================
example = vim.fn.stdpath "data" .. "/lazy/compiler.nvim/tests/examples/dart/transpiled/"
