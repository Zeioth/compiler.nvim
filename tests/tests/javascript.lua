...
--- @usage :luafile ~/.local/share/nvim/lazy/compiler.nvim/tests/tests/javascript.lua

local ms = 1000 -- wait time
local language = require("compiler.languages.javascript")
local example = vim.fn.stdpath "data" .. "/lazy/compiler.nvim/tests/examples/javascript/"
